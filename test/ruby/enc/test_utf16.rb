...
EOT
  ...
  def test_utf16be_valid_encoding
    [
      ...
      s = s.dup.force_encoding("utf-16be")
  ...
  def test_utf16le_valid_encoding
    [
      ...
      s = s.dup.force_encoding("utf-16le")
      assert_equal(true, s.valid_encoding?, "#{encdump s}.valid_encoding?")
    }
    [
      "\x00",
  ...
  def test_intern
    s = "aaaa".dup.force_encoding("utf-16be")
    assert_equal(s.encoding, s.intern.to_s.encoding, "#{encdump s}.intern.to_s.encoding")
  end

  def test_sym_eq
    s = "aa".dup.force_encoding("utf-16le")
    assert_not_equal(:aa, s.intern, "#{encdump s}.intern != :aa")
  end

  def test_compatible
    s1 = "aa".dup.force_encoding("utf-16be")
    s2 = "z".dup.force_encoding("us-ascii")
  ...
  def test_end_with
    s1 = "ab".dup.force_encoding("utf-16be")
    s2 = "b".dup.force_encoding("utf-16be")
  ...
  def test_plus
    s1 = "a".dup.force_encoding("us-ascii")
    s2 = "aa".dup.force_encoding("utf-16be")
  ...
  def test_encoding_find
    assert_raise(ArgumentError) {
      Encoding.find("utf-8".dup.force_encoding("utf-16be"))
    }
  end
  ...
  def test_slice!
    enccall("aa".dup.force_encoding("UTF-16BE"), :slice!, -1)
  end
  ...
  def test_plus_empty2
    s1 = "aa"
    s2 = "".dup.force_encoding("utf-16be")
    assert_nothing_raised("#{encdump s1} << #{encdump s2}") {
      s1 + s2
    }
  end
  ...
  def test_plus_nonempty
    s1 = "aa"
    s2 = "bb".dup.force_encoding("utf-16be")
    assert_raise(Encoding::CompatibilityError, "#{encdump s1} << #{encdump s2}") {
      s1 + s2
    }
  end
  ...
  def test_succ
    s = "\xff\xff".dup.force_encoding("utf-16be")
    assert_predicate(s.succ, :valid_encoding?, "#{encdump s}.succ.valid_encoding?")

    s = "\xdb\xff\xdf\xff".dup.force_encoding("utf-16be")
    assert_predicate(s.succ, :valid_encoding?, "#{encdump s}.succ.valid_encoding?")
  end

  def test_regexp_union
    enccall(Regexp, :union, "aa".dup.force_encoding("utf-16be"), "bb".dup.force_encoding("utf-16be"))
  end

  def test_empty_regexp
    s = "".dup.force_encoding("utf-16be")
    assert_equal(Encoding.find("utf-16be"), Regexp.new(s).encoding,
                "Regexp.new(#{encdump s}).encoding")
  end

  def test_regexp_match
    assert_raise(Encoding::CompatibilityError) { Regexp.new("aa".dup.force_encoding("utf-16be")) =~ "aa" }
  end

  def test_gsub
    s = "abcd".dup.force_encoding("utf-16be")
    assert_nothing_raised {
      s.gsub(Regexp.new(".".encode("utf-16be")), "xy")
    }
    s = "ab\0\ncd".dup.force_encoding("utf-16be")
    assert_raise(Encoding::CompatibilityError) {
      s.gsub(Regexp.new(".".encode("utf-16be")), "xy")
    }
  end
  ...
  def test_is_mbc_newline
    sl = "f\0o\0o\0\n\0b\0a\0r\0\n\0b\0a\0z\0\n\0".dup.force_encoding("utf-16le")
    sb = "\0f\0o\0o\0\n\0b\0a\0r\0\n\0b\0a\0z\0\n".dup.force_encoding("utf-16be")
    al = sl.lines.to_a
    ab = sb.lines.to_a
    assert_equal("f\0o\0o\0\n\0".dup.force_encoding("utf-16le"), al.shift)
    assert_equal("b\0a\0r\0\n\0".dup.force_encoding("utf-16le"), al.shift)
    assert_equal("b\0a\0z\0\n\0".dup.force_encoding("utf-16le"), al.shift)
    assert_equal("\0f\0o\0o\0\n".dup.force_encoding("utf-16be"), ab.shift)
    assert_equal("\0b\0a\0r\0\n".dup.force_encoding("utf-16be"), ab.shift)
    assert_equal("\0b\0a\0z\0\n".dup.force_encoding("utf-16be"), ab.shift)

    sl = "f\0o\0o\0\n\0".dup.force_encoding("utf-16le")
    sb = "\0f\0o\0o\0\n".dup.force_encoding("utf-16be")
    sl2 = "f\0o\0o\0".dup.force_encoding("utf-16le")
    sb2 = "\0f\0o\0o".dup.force_encoding("utf-16be")
  ...
  def test_code_to_mbc
    assert_equal("a\0".dup.force_encoding("utf-16le"), "a".ord.chr("utf-16le"))
    assert_equal("\0a".dup.force_encoding("utf-16be"), "a".ord.chr("utf-16be"))
  end
  ...
  def test_surrogate_pair
    sl = "\x42\xd8\xb7\xdf".dup.force_encoding("utf-16le")
    sb = "\xd8\x42\xdf\xb7".dup.force_encoding("utf-16be")
  ...
  def test_regexp_escape
    s = "\0*".dup.force_encoding("UTF-16BE")
    r = Regexp.new(Regexp.escape(s))
    assert_match(r, s, "#{encdump(r)} =~ #{encdump(s)}")
  end

  def test_casecmp2
    assert_equal(0, "\0A".dup.force_encoding("UTF-16BE").casecmp("\0a".dup.force_encoding("UTF-16BE")))
    assert_not_equal(0, "\0A".dup.force_encoding("UTF-16LE").casecmp("\0a".dup.force_encoding("UTF-16LE")))
    assert_not_equal(0, "A\0".dup.force_encoding("UTF-16BE").casecmp("a\0".dup.force_encoding("UTF-16BE")))
    assert_equal(0, "A\0".dup.force_encoding("UTF-16LE").casecmp("a\0".dup.force_encoding("UTF-16LE")))

    ary = ["01".dup.force_encoding("UTF-16LE"),
           "10".dup.force_encoding("UTF-16LE")]
    e = ary.sort {|x,y| x <=> y }
