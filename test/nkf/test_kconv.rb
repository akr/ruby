...
\x52\x75\x62\x79".dup.force_encoding('EUC-JP')
    @utf8_str = "\
...
\x52\x75\x62\x79".dup.force_encoding('UTF-8')
    @sjis_str = "\
\x83\x49\x83\x75\x83\x57\x83\x46\x83\x4e\x83\x67\x8e\x77\x8c\xfc\
\x83\x76\x83\x8d\x83\x4f\x83\x89\x83\x7e\x83\x93\x83\x4f\x8c\xbe\x8c\xea
\x52\x75\x62\x79".dup.force_encoding('Shift_JIS')
    @jis_str = "\
...
\x52\x75\x62\x79".dup.force_encoding('ISO-2022-JP')
  end
